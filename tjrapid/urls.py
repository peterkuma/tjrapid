...
urlpatterns += [
	...
	re_path(r'^(?P<category_name>ob)/preteky/(?P<name>[^/]+)/mapa/$', ob.views.event_map, kwargs={'lang': 'sk'}),
	...
	re_path(r'^(?P<lang>en)/(?P<category_name>orienteering)/events/(?P<name>[^/]+)/map/$', ob.views.event_map),
